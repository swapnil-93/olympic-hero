...
# Rename the columns Total
data.rename(columns={'Total':'Total_Medals'}, inplace=True)

# Print frst 10 records
print(data.head())
...
# --------------
#Code starts here
# Create new dataframe for summer_df
summer_df['Golden_Ratio'] = summer_df['Gold_Summer']/summer_df['Total_Summer']

# Find max value for gold ratio
summer_max_ratio = max(summer_df['Golden_Ratio'])

# Find the country associated with it
summer_country_gold = summer_df.loc[summer_df['Golden_Ratio'].idxmax(), 'Country_Name']

# Create new dataframe for winter_df
...
# Create new dataframe for top_df
